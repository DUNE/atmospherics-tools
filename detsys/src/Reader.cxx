...
void Reader<T>::UpdateData(){
    ...
    if (_data.Selection == Sel::SelNC) _data.erec = _sr->common.ixn.pandora[0].Enu.calo;
    else if (_data.Selection == Sel::SelNuMu) _data.erec = _sr->common.ixn.pandora[0].Enu.lep_calo;
    else if (_data.Selection == Sel::SelNuE) _data.erec = _sr->common.ixn.pandora[0].Enu.e_calo;
    else {
